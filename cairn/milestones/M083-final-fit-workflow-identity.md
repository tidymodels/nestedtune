...
- [ ] T5: Help pages (`R/nested-final-fit.R:91`, `R/extract-procedure.R`, `R/nested-fit-resamples.R:47`), DESIGN.md Architecture (`cairn/DESIGN.md:99`), a NEWS bullet; `devtools::check()` 0/0/0.
