...
- 2026-09-08: step-7 approval: PR #85 approved for merge. The five follow-up findings take one new candidate row (F1-F4) and the existing CI-timing row (F5) at the hygiene pass.
