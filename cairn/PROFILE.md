...
- Six divergences from that stock shape (M11 ×2, M12 rev. M31, M14, M33, M52). **A `concurrency` block**
  ...
  minutes and its `check-r-package` step at 30 (40 on the devel and windows legs since M72, whose tests pushed
  steps already at 28–29.5 minutes past 30), `test-coverage` its job at 20, `R-CMD-check-hard` its job at 30 (M57;
