...
#' the fit was built from, and for a fit built from a workflow set it is that
#' workflow's rows of [collect_metrics()] on the set. See [nested_final_fit()] for why that is the
