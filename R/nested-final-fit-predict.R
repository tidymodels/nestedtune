...
#' has not. The number to report is [collect_metrics()] on the fit's results
#' object, or, for a fit built from a workflow set, that workflow's rows of
#' [collect_metrics()] on the set. See [nested_final_fit()] for why that is the
