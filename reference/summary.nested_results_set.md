...
when any workflow has a failed fold, how many do;
[`summary()`](https://rdrr.io/r/base/summary.html) names the folds. A
tuned parameter whose id is `wflow_id` cannot be tabulated beside the
