...
whether the split is representative. nestedtune scores the whole
...
deploy. The deployed model is the same procedure run once more on all the
data. The estimate is the number to report for it, and there is no second
one to compute.
